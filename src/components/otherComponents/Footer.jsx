...
const Footer = () => {
  return (
    <div className="bg-[#505bfe]  bg-opacity-95  p-10 text-white">
      <div
        className="grid justify-center w-full gap-4 text-center sm:grid-cols-2 md:grid-cols-4 md:gap-2 md:text-left "
      ...
      >
        ...
        <div className="mx-auto">
          <div>
            <span className="font-semibold underline uppercase underline-offset-2">
              Address
            </span>
            <br />
