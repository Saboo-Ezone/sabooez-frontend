      ...
      >
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-6'>
          <div className=' mb-6'>
            ...
            <br />
            <br />
            <button className='group relative h-min overflow-hidden border-[2px] border-[#00c389]  px-2 py-2 font-mono text-[#00c389]   shadow-inner '>
          ...
          <div className='mb-4 font-roboto text-sm leading-5 lg:col-span-2 lg:px-16'>
